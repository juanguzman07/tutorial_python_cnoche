...
#adjuntar
notas = [0, 0, 7.0, 8.0, 5.0, 10.0, 7.0, 7.5, 4.0, 10.0, 7.0, 7.0, 8.0, 9.0, 7.5]
suma_de_notas = sum(notas)
print(suma_de_notas)

#La función built-in len () devuelve la longitud
notas = [0, 0, 9.0, 3.0, 5.0, 10.0, 7.0, 7.5, 4.0, 10.0, 5.0, 7.0, 8.0, 6.0, 7.5]
...
notas = [0, 0, 7.0, 9.0, 5.0, 10.0, 7.0, 7.5, 4.0, 10.0, 7.0, 7.0, 6.0, 8.0, 7.5]
notas.remove(9.0)
print(notas)
